  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-100 text-gray-900 relative">
      ...
      <div className="flex flex-1">
        ...
        {!isWhatsAppFull && (
          <aside className="hidden md:flex w-64 bg-[#101826] text-white md:fixed md:top-0 md:left-0 md:h-screen">
            <SidebarContent />
          </aside>
        )}
        ...
        <main className={`flex-1 overflow-auto ${isWhatsAppFull ? "p-0" : "p-4 md:p-6"} md:ml-64`} style={{ maxHeight: "100vh" }}>
          <Outlet />
        </main>
      </div>
    </div>
