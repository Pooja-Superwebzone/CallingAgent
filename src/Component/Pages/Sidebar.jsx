...
//   const trialMinutes = location.state?.trialMinutes || "10";

//   if (showWelcome) {
//     setShowWelcomeModal(true); // 👈 triggers the Welcome modal
//     setTrialMinutes(trialMinutes);
//     setRemainingMinutes(trialMinutes);
//     setIsSignupUser(true);

//     // Save to localStorage for future reference
//     localStorage.setItem("userRemainingMinutes", trialMinutes.toString());
//     localStorage.setItem("isSignupUser", "true");

//     // Clean up history state and avoid showing modal again on refresh
//     window.history.replaceState({}, document.title);
//     navigate(location.pathname, { replace: true });
//   }
...
//         {showWelcomeModal && (role === 'admin' && twilioUser === 1) && (
