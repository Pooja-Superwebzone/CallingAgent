...
function Sendcall() {
        ...
        for (let i = 0; i < parsedRows.length; i++) {
          ...
          if (brand && !useStaticScript && !script.trim()) {
            ...
            payload = {
              ...
              ...(selectedTemplate ? { whatsapp_id: selectedTemplate } : {})
            };
          }
  ...
  const computePercent = (value) => {
    const max = Math.max(oneWayMinutes, 1);
